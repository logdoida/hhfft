...
#include "hhfft_1d_real_setter_f.h"
#include <stdexcept>
#include <assert.h>
#include <cmath>
...
void hhfft::HHFFT_1D_Real_F_set_complex_to_complex_packed_function(StepInfoF &step_info, hhfft::InstructionSet instruction_set)
{
...
void hhfft::HHFFT_1D_Real_F_odd_set_function(StepInfoF &step_info, hhfft::InstructionSet instruction_set)
{
...
void hhfft::HHFFT_1D_Real_F_set_small_function(StepInfoF &step_info, size_t n, bool forward, hhfft::InstructionSet instruction_set)
{
    step_info.step_function = nullptr;
