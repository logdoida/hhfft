...
template<RadixType radix_type> void fft_2d_real_odd_rows_forward_sse2_d(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info)
{
    const hhfft::RadersD &raders = *step_info.raders;
    size_t radix = get_actual_radix<radix_type>(raders);
...
template<RadixType radix_type> void fft_2d_real_odd_rows_first_level_inverse_sse2_d(const double *data_in, double *data_out, const hhfft::StepInfo<double> &step_info)
{
    const hhfft::RadersD &raders = *step_info.raders;
    size_t radix = get_actual_radix<radix_type>(raders);
    size_t repeats = step_info.repeats;
...
template<RadixType radix_type> inline void fft_1d_real_one_level_inverse_sse2_internal_d(const double *data_in, double *data_out, double *data_raders, const hhfft::RadersD &raders, const hhfft::StepInfo<double> &step_info)
{    
    size_t repeats = step_info.repeats;
    size_t stride = step_info.stride;
    double *twiddle_factors = step_info.twiddle_factors;    
...
template<RadixType radix_type> void fft_1d_real_one_level_inverse_sse2_d(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info)
{
    ...
    fft_1d_real_one_level_inverse_sse2_internal_d<radix_type>(data_in, data_out, data_raders, raders, step_info);
...
template<RadixType radix_type> void fft_2d_real_odd_rows_inverse_sse2_d(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info)
{
    const hhfft::RadersD &raders = *step_info.raders;
    size_t radix = get_actual_radix<radix_type>(raders);
    size_t n = step_info.size;
    ...
    if (stride == 1)
        ...
        data_raders = allocate_raders_D2S<radix_type>(raders);

    // Process all rows separately
    for (size_t j = 0; j < n; j++)
    {        
        fft_1d_real_one_level_inverse_sse2_internal_d<radix_type>(data_in + j*m, data_out + j*m, data_raders, raders, step_info);
    }
...
template void fft_1d_real_1level_sse2_d<11, false>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
...
template void fft_1d_real_1level_sse2_d<13, false>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
...
template void fft_1d_real_1level_sse2_d<22, false>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_1d_real_1level_sse2_d<26, false>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
...
template void fft_1d_real_1level_sse2_d<11, true>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
...
template void fft_1d_real_1level_sse2_d<13, true>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
...
template void fft_1d_real_1level_sse2_d<22, true>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_1d_real_1level_sse2_d<26, true>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
...
template void fft_1d_real_first_level_forward_sse2_d<Radix11>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_1d_real_first_level_forward_sse2_d<Radix13>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
...
template void fft_1d_real_first_level_inverse_sse2_d<Radix11>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_1d_real_first_level_inverse_sse2_d<Radix13>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
...
template void fft_1d_real_one_level_forward_sse2_d<Radix11>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_1d_real_one_level_forward_sse2_d<Radix13>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
...
template void fft_1d_real_one_level_inverse_sse2_d<Radix11>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_1d_real_one_level_inverse_sse2_d<Radix13>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);

template void fft_2d_real_odd_rows_forward_sse2_d<Raders>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_forward_sse2_d<Radix3>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_forward_sse2_d<Radix5>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_forward_sse2_d<Radix7>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_forward_sse2_d<Radix11>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_forward_sse2_d<Radix13>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);

template void fft_2d_real_odd_rows_first_level_inverse_sse2_d<Raders>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_first_level_inverse_sse2_d<Radix3>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_first_level_inverse_sse2_d<Radix5>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_first_level_inverse_sse2_d<Radix7>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_first_level_inverse_sse2_d<Radix11>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_first_level_inverse_sse2_d<Radix13>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);

template void fft_2d_real_odd_rows_inverse_sse2_d<Raders>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_inverse_sse2_d<Radix3>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_inverse_sse2_d<Radix5>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_inverse_sse2_d<Radix7>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_inverse_sse2_d<Radix11>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
template void fft_2d_real_odd_rows_inverse_sse2_d<Radix13>(const double *data_in, double *data_out,const hhfft::StepInfo<double> &step_info);
