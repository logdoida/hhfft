...
inline ComplexF mul_F(ComplexF a, ComplexF b)
{
    ...
    ComplexF a2 = _mm_permute_ps(a, 1); // Not supported in sse2

    ComplexF t1 = _mm_mul_ps(a1, b);
    ComplexF t2 = _mm_mul_ps(a2, b);

    ComplexF y = _mm_hadd_ps(t1, t2); // Not supported in sse2
    return y;
}
#else
inline ComplexF mul_F(ComplexF a, ComplexF b)
...
inline ComplexF mul_conj_F(ComplexF a, ComplexF b)
{
    // TODO
    // If AVX-was supported...
    ComplexF a1 = change_sign_F(a, const2_F);
    ComplexF b1 = _mm_permute_ps(b, 1); // Not supported in sse2

    ComplexF t1 = _mm_mul_ps(a, b);
    ComplexF t2 = _mm_mul_ps(a1, b1);
...
inline ComplexF2 mul_F2(ComplexF2 a, ComplexF2 b)
{
    // TODO
    // If AVX was supported...
    ComplexF2 a1 = change_sign_F(a, const1_F);
    ComplexF2 a2 = _mm_permute_ps(a, 1); // Not supported in sse2

    ComplexF2 t1 = _mm_mul_ps(a1, b);
    ComplexF2 t2 = _mm_mul_ps(a2, b);

    ComplexF2 y = _mm_hadd_ps(t1, t2); // Not supported in sse2
    return y;
}
#else
inline ComplexF2 mul_F2(ComplexF2 a, ComplexF2 b)
{
    ComplexF2 a1 = change_sign_F(a, const1_F2);
    ComplexF2 a2 = _mm_shuffle_ps(a, a, 1*1 + 0*4 + 3*16 + 2*64);

    ComplexF2 t1 = _mm_mul_ps(a1, b);
    ComplexF2 t2 = _mm_mul_ps(a2, b);

    ComplexF2 t3 = _mm_unpacklo_ps(t1, t2);
    ComplexF2 t4 = _mm_unpackhi_ps(t1, t2);

    ComplexF2 t5 = _mm_shuffle_ps(t3, t4, 0*1 + 1*4 + 0*16 + 1*64);
    ComplexF2 t6 = _mm_shuffle_ps(t3, t4, 2*1 + 3*4 + 2*16 + 3*64);

    ComplexF2 y = _mm_add_ps(t5, t6);
...
inline ComplexF2 mul_conj_F2(ComplexF2 a, ComplexF2 b)
{
    // TODO
    // If AVX-was supported...
    ComplexF2 a1 = change_sign_F(a, const2_F);
    ComplexF2 b1 = _mm_permute_ps(b, 1); // Not supported in sse2

    ComplexF2 t1 = _mm_mul_ps(a, b);
    ComplexF2 t2 = _mm_mul_ps(a1, b1);
...
inline ComplexF2 mul_conj_F2(ComplexF2 a, ComplexF2 b)
{
    ComplexF2 a1 = change_sign_F(a, const2_F2);
...
inline ComplexF2 mul_i_F2(ComplexF2 a)
{
    ...
    // If AVX-was supported...
    ComplexF2 a1 = change_sign_F(a, const1_F);
    ComplexF2 y = _mm_permute_ps(a1, 1);
    return y;
}
#else
inline ComplexF2 mul_i_F2(ComplexF2 a)
