...
#ifndef HHFFT_PLAIN_D_H
#define HHFFT_PLAIN_D_H
...
// This class is to be used when there is no AVX/AVX512 support
class HHFFT_Plain_D : public HHFFT_Base<double>
{
public:
    HHFFT_Plain_D(size_t n, size_t m);
