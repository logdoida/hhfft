...
#ifndef HHFFT_PLAIN_AVX_D_H
#define HHFFT_PLAIN_AVX_D_H
...
// This class is can be used when there is AVX support. No hand optimization though

class HHFFT_Plain_AVX_D : public HHFFT_Base<double>
{
public:
    HHFFT_Plain_AVX_D(size_t n, size_t m);
