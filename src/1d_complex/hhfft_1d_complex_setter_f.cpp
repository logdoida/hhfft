...
#include "hhfft_1d_complex_setter.h"
#include <stdexcept>
#include <assert.h>
#include <cmath>
...
void set_radix_f(StepInfoF &step_info, hhfft::InstructionSet instruction_set)
{
    ...
    {
        set_stride_type_f<Radix11>(step_info, instruction_set);
    } else if (radix == 13)
    {
        set_stride_type_f<Radix13>(step_info, instruction_set);
    } else if (radix > 13)
    {
...
namespace hhfft
{
    ...
    template<> void HHFFT_1D_Complex_set_reorder_function<float>(StepInfoF &step_info, hhfft::InstructionSet instruction_set)
    {
    ...
    template<> void HHFFT_1D_Complex_set_function<float>(StepInfoF &step_info, hhfft::InstructionSet instruction_set)
    {
        step_info.step_function = nullptr;
    ...
    template<> void (*HHFFT_1D_Complex_set_convolution_function<float>(hhfft::InstructionSet instruction_set))(const float *, const float *, float *, size_t)
    {
    /*
    #ifdef HHFFT_COMPILED_WITH_AVX512F
        if (instruction_set == hhfft::InstructionSet::avx512f)
...
namespace hhfft
{
    template<> std::vector<size_t> HHFFT_1D_Complex_set_small_function<float>(StepInfoF &step_info, size_t n, bool forward, hhfft::InstructionSet instruction_set)
    {
        step_info.step_function = nullptr;
        ...
        switch (n)
        {
            ...
            case 11:
                return set_small_function_instruction_set_f<11,1>(step_info, instruction_set, forward);
            case 13:
                return set_small_function_instruction_set_f<13,1>(step_info, instruction_set, forward);
            ...
            case 22:
                return set_small_function_instruction_set_f<2,11>(step_info, instruction_set, forward);
            case 24:
            ...
            case 26:
                return set_small_function_instruction_set_f<2,13>(step_info, instruction_set, forward);
            case 28:
            ...
            case 33:
                return set_small_function_instruction_set_f<3,11>(step_info, instruction_set, forward);
            case 35:
            ...
            case 39:
                return set_small_function_instruction_set_f<3,13>(step_info, instruction_set, forward);
            case 40:
            ...
            case 44:
                return set_small_function_instruction_set_f<4,11>(step_info, instruction_set, forward);
            case 48:
            ...
            case 52:
                return set_small_function_instruction_set_f<4,13>(step_info, instruction_set, forward);
            case 55:
                return set_small_function_instruction_set_f<5,11>(step_info, instruction_set, forward);
            case 56:
    ...
    template<> void HHFFT_1D_Complex_set_1level_raders_function<float>(StepInfoF &step_info, bool forward, hhfft::InstructionSet instruction_set)
    {
    #ifdef HHFFT_COMPILED_WITH_AVX
        if (instruction_set == hhfft::InstructionSet::avx)
        {
