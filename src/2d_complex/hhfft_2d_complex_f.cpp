...
void hhfft::HHFFT_2D_Complex_F_set_function_columns(StepInfoF &step_info, hhfft::InstructionSet instruction_set)
{
...
void hhfft::HHFFT_2D_Complex_F_set_function_rows(StepInfoF &step_info, hhfft::InstructionSet instruction_set)
{  
    step_info.step_function = nullptr;
