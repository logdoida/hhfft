...
#include "../1d_complex/hhfft_1d_complex_common_d.h"

using namespace hhfft;


template<size_t radix, bool forward>
    inline void fft_2d_complex_column_twiddle_dit_plain_d_internal(const double *data_in, double *data_out, const double *twiddle_factors, size_t stride)
{
    ...
    void fft_2d_complex_column_twiddle_dit_plain_d(const double *data_in, double *data_out, hhfft::StepInfo<double> &step_info)
{
    ...
    {
        // TODO stride loop needs to be added here!
